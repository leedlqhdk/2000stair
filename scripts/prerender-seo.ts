...
const STATIC_BODY_COMMON = `
  <section>
    <h2>서비스 및 요금</h2>
    <ul>
      <li>계단청소 정기관리: 월 4회(주 1회) 추천 기준, 2층 60,000원 / 3층 70,000원 / 4층 80,000원 / 5층 90,000원 / 6층 100,000원 / 7층 110,000원 / 8층 120,000원. 최대 8층까지 작업.</li>
      <li>화장실청소·유리청소·사무실청소: 현장 조건을 확인한 뒤 별도 안내.</li>
    </ul>
  </section>
  <section>
    <h2>관리 지역</h2>
    <p>경기도 이천시 전 지역을 대상으로 하며, 실제 관리 가능 여부는 주소와 건물 사진을 확인한 뒤 안내합니다.</p>
  </section>
  <section>
    <h2>업체 정보</h2>
