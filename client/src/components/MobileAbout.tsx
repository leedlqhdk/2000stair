      ...
      <section className="px-5 py-7">
        ...
        >
          <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2">
            <div className="rounded-2xl border border-blue-100 bg-white p-3.5 shadow-[0_2px_10px_rgba(15,23,42,0.04)]">
              <span className="whitespace-nowrap rounded-full bg-blue-50 px-2.5 py-1 text-[10px] font-extrabold text-primary">
                {husbandRole.badge}
              </span>
              <ul className="mt-3 space-y-2.5">
                {husbandRole.items.map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-1.5 whitespace-nowrap text-[11.5px] font-bold leading-tight text-slate-700"
                  >
            ...
            <img
              src="/booboo.webp"
              alt="이천계단지기 부부 캐릭터"
              className="w-[92px] shrink-0 object-contain"
              loading="lazy"
            />
