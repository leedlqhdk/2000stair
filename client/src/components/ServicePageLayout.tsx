  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        <section
          className="relative flex min-h-[460px] flex-col justify-end overflow-hidden bg-gray-900 pb-14 pt-24 md:min-h-[580px]"
          style={
        ...
        >
          ...
          <div className="relative container mx-auto px-4">
            <motion.h1
              ...
              className="whitespace-pre-line font-['GmarketSans'] text-3xl font-extrabold leading-tight text-white sm:text-4xl md:text-5xl"
            >
              {data.heroTitle}
            </motion.h1>
            <motion.div
