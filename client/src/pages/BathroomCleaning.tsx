...
소독은 기본 옵션으로 포함되며, 사용자가 많은 다중이용시설의 경우 적어도 일주일에 한 번씩은 정기관리를 권장합니다. 건물 입주자나 방문 고객에게 청결하고 쾌적한 화장실을 제공하는 것은 건물 전체의 신뢰도와 직결됩니다.`,
        ...
        faq: [
          ...
          {
            q: "화장실 요석 제거도 가능한가요?",
            a: "가능합니다. 변기 및 소변기에 장기간 누적된 요석은 일반 청소만으로 제거되지 않아 전용 약품과 집중 작업이 필요합니다. 오염 상태에 따라 초기 복원 작업이 포함될 수 있으며, 이후 정기관리를 통해 깨끗한 상태를 유지해드립니다. ※ 장기간 누적으로 인한 도기 내부 착색은 일부 남을 수 있습니다.",
          },
          {
            q: "정기청소인데 왜 초벌 작업이 필요한가요?",
            a: "장기간 관리되지 않은 화장실은 첫 방문 시 오염 제거에 많은 시간이 소요됩니다. 이 경우 첫 방문에는 일반 정기청소보다 더욱 꼼꼼한 복원 작업이 진행되며, 이후 정기관리를 통해 항상 깨끗한 상태를 유지할 수 있습니다.",
          },
        ],
        showReviews: true,
      }}
