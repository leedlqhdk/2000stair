  ...
  return (
    <ServicePageLayout
      data={{
        ...
        heroTitle: "매일 오르는 계단,\n누가 관리하고 있나요?",
        heroSubtitle: "빌라·상가·원룸 계단 관리 범위·주기·비용 안내",
        seoTitle: "계단청소 범위·주기·비용 안내 – 이천계단지기",
        features: [
          { title: "부부 직접 관리", description: "처음부터 끝까지 부부가 직접 관리합니다." },
          { title: "대표 직접 담당", description: "대표가 직접 방문해 건물 상태에 맞춰 관리합니다." },
          { title: "초도청소 후 청소 전후 사진 제공", description: "요청시 초도청소 후 청소 전후 사진을 카톡으로 전달해드립니다." },
...
이천계단지기는 빌라, 원룸, 상가 건물의 계단 정기관리를 현장 상태에 맞춰 안내합니다. 계단 바닥 약품 세척, 난간·손잡이 오염 제거, 공동현관 유리 청소, 거미줄 제거까지 관리 범위를 확인한 뒤 진행합니다.

월 2회 또는 4회 정기관리를 통해 건물이 항상 깔끔하게 유지됩니다. 상가 건물의 경우 방문 고객에게 청결한 첫인상을 주는 것이 입점 업체 매출에도 영향을 줄 수 있습니다. 부부가 직접 담당하기 때문에 일관된 품질을 유지할 수 있으며, 초도청소 후 청소 전후 사진 제공으로 건물주가 직접 확인하실 수 있습니다.`,
        },
        needSection: {
          title: "계단청소,\n어떤 건물에 필요할까요?",
