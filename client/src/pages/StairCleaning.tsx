      ...
      data={{
        ...
        infoSections: [
          ...
          },
          {
            ...
            body: "월 2회 또는 4회 정기관리를 통해 건물이 항상 깔끔하게 유지됩니다. 상가 건물의 경우 방문 고객에게 청결한 첫인상을 주는 것이 입점 업체 매출에도 영향을 줄 수 있습니다. 부부가 직접 담당하기 때문에 일관된 품질을 유지할 수 있으며, 매회 작업 전후 사진을 전달해드려 건물주가 직접 확인하실 수 있습니다.",
        ...
        faq: [
          {
            q: "계단청소 비용은 얼마인가요?",
            a: "빌라 2~3층 기준 월 2회 40,000원~부터 시작합니다(부가세 별도). 건물 층수, 면적, 관리 횟수에 따라 달라지며 현장 확인 후 정확한 견적을 안내드립니다.",
          },
          {
