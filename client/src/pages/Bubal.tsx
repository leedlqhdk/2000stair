        ...
        <section className="mb-12 md:mb-16">
          <div className="grid overflow-hidden rounded-[1.5rem] border border-blue-100 bg-white shadow-sm md:grid-cols-[180px_minmax(0,1fr)]">
            ...
            <div className="p-6 md:p-8">
              ...
              <h2 className="mb-3 text-xl font-extrabold text-foreground md:text-2xl">부발읍 작업 기록을 정리하고 있습니다</h2>
              <p className="text-sm leading-7 text-muted-foreground">
                실제 작업 사진과 일지는 정리되는 순서대로 추가됩니다. 기록이 올라오기 전에도 계단·복도·공동현관 사진을 보내주시면 관리 가능 범위와 견적을 안내드립니다.
              </p>
            </div>
          </div>
        </section>
