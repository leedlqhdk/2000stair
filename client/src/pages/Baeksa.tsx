...
const serviceCards = [
{ title: "관리 대상", text: "백사면 빌라, 다세대, 원룸, 상가 건물의 계단·복도·공동현관을 관리합니다." },
{ title: "청소 범위", text: "계단 바닥, 난간, 공동현관, 유리문, 우편함 주변처럼 눈에 잘 띄는 공용부를 확인합니다." },
{ title: "진행 방식", text: "건물 사진을 먼저 확인한 뒤 오염도, 층수, 관리 주기에 맞춰 작업 범위를 안내합니다." },
];
...
<Link href="/areas"><a className="mb-6 inline-flex items-center gap-2 text-sm font-bold text-primary transition hover:opacity-80"><ArrowLeft className="h-4 w-4" />관리지역으로 돌아가기</a></Link>
...
<h1 className="mb-4 text-3xl font-extrabold leading-[1.18] text-foreground md:text-4xl">백사면 작업 기록과 공용공간 관리를 준비하고 있습니다</h1>
<p className="max-w-2xl text-base leading-8 text-muted-foreground">백사면 빌라·원룸·상가 공용공간 관리 기록을 정리하고 있습니다. 작업 기록은 업데이트 중이며, 상담과 견적 안내는 바로 가능합니다.</p>
</div>
