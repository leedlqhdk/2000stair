...
{
title: "ê´ë¦¬ ëì",
text: "ë°±ì¬ë©´ ë¹ë¼, ë¤ì¸ë, ìë£¸, ìê° ê±´ë¬¼ì ê³ë¨Â·ë³µëÂ·ê³uëíê´ì ê´ë¦¬í©ëë¤.",
},
{
title: "ì²­ì ë²ì",
text: "ê³ë¨ ë°ë¥, ëê°, ê³µëíê´, ì ë¦¬ë¬¸, ì°í¸í¨ ì£¼ë³ì²ë¼ ëì ì ëë ê³µì©ë¶ë¥¼ íì¸í©ëë¤.",
},
{
title: "ì§í ë°©ì",
text: "ê±´ë¬¼ ì¬ì§ì ë¨¼ì  íì¸í ë¤ ì¤ì¼ë, ì¸µì, ê´ë¦¬ ì£¼ê¸°ì ë§ì¶° ìì ë²ìë¥¼ ìë´í©ëë¤.",
},
];

const reviews = [
"ê±´ë¬¼ ìêµ¬ì ê³ë¨ì´ ì ë¦¬ëë ì²«ì¸ìì´ í¨ì¬ ì¢ìì¡ìµëë¤.",
"ì ê¸°ì ì¼ë¡ ê´ë¦¬ ë°©í¥ì ìë ¤ì£¼ìì ë¯¿ê³  ë§¡ê¸¸ ì ìììµëë¤.",
];

const faqs = [
{
question: "ë°±ì¬ë©´ë ì ê¸°ê´ë¦¬ ê°ë¥íê°ì?",
answer: "ê°ë¥í©ëë¤. ëª¨ì ë¦¬, ì¡°ìë¦¬, íë°©ë¦¬ ë± ë°±ì¬ë©´ ì£¼ì ì§ì­ì ì£¼ìì ì¬ì§ íì¸ í ê´ë¦¬ ê°ë¥ ì¬ë¶ë¥¼ ìë´ëë¦½ëë¤.",
},
{
question: "ìì ì  ë°©ë¬¸ ê²¬ì ì´ íìíê°ì?",
answer: "ì¬ì§ë§ì¼ë¡ 1ì°¨ ìë´ê° ê°ë¥íê³ , ì¤ì¼ëë ë²ì íì¸ì´ íìí ê²½ì° ë°©ë¬¸ ì¼ì ì ì¡°ì¨í©ëë¤.",
},
];
...
useEffect(() => {
  document.title = "ë°±ì¬ë©´ ê³ë¨ì²­ì ì ë¬¸ | ì´ì²ê³ë¨ì§ê¸°";
}, []);
...
ë°±ì¬ë©´ ìì ê¸°ë¡ê³¼ ê³µì©ê³µê° ê´ë¦¬ë¥¼ ì¤ë¹íê³  ììµëë¤
</h1>
<p className="max-w-2xl text-base leading-8 text-muted-foreground">
ë°±ì¬ë©´ ë¹ë¼Â·ìë£¸Â·ìê° ê³µì©ê³µê° ê´ë¦¬ ê¸°ë¡ì ì ë¦¬íê³  ììµëë¤. ìì ê¸°ë¡ì ìë°ì´í¸ ì¤ì´ë©°, ìë´ê³¼ ê²¬ì  ìë´ë ë°ë¡ ê°ë¥í©ëë¤.
</p>
</div>
...
<li className="flex gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />ê³ë¨ê³¼ ë³µë ì ì²´</li>
<li className="flex gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />ê³µëíê´ê³¼ ì ë¦¬ë¬¸</li>
<li className="flex gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />ë¨¼ì§Â·ì¼ë£©ì´ ë§ì êµ¬ê°</li>
</ul>
</div>
</div>
</div>
...
posts={posts}
title="ë°±ì¬ë©´ ìì ì¼ì§"
description="ë°±ì¬ë©´ íì¥ ì¬ì§ì ì ë¦¬ëë ììëë¡ ìì ì¼ì§ì ì¶ê°ë©ëë¤."
emptyMessage="ë°±ì¬ë©´ ìì ê¸°ë¡ì ì¬ì§ ì ë¦¬ í ììëë¡ ì¶ê°í ê²ì. ìë´ê³¼ ê²¬ì  ìë´ë ì§ê¸ë ê°ë¥í©ëë¤."
/>
...
<p className="mt-4 text-sm text-muted-foreground">ë°±ì¬ë©´ ì¸ê·¼ ê±´ë¬¼ ê´ë¦¬ í¼ëë°±</p>
</div>
))}
</section>
...
<h2 className="mb-3 text-2xl font-extrabold text-foreground md:text-3xl">ë°±ì¬ë©´ ì²­ì ê´ë¦¬ê° íìíì ê°ì?</h2>
