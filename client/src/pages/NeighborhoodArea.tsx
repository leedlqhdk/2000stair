...
const neighborhoodData: Record<string, NeighborhoodConfig> = {
  gwango: {
    ...
    description:
      "관고동 생활권의 상가, 빌라, 소형 건물 공용공간을 현장 상태에 맞춰 직접 관리합니다. 관할 구역은 사음동 일대를 포함합니다.",
  ...
  jungni: {
    ...
    description:
      "중리동 건물의 현관, 계단, 복도 상태를 사진으로 확인한 뒤 필요한 관리 범위를 안내합니다. 관할 구역은 증일동, 율현동, 진리동, 단월동, 대포동, 고담동, 장록동 일대를 포함합니다.",
  ...
  jeungpo: {
    ...
    description:
      "증포동 생활권의 빌라, 원룸, 상가주택 공용공간을 주소와 사진 기준으로 확인하고 직접 관리합니다. 관할 구역은 안흥동, 갈산동, 송정동 일대를 포함합니다.",
